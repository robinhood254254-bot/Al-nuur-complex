...
<section class="category-page-header">
    <div class="container">
        ...
        <p>Quality appliances from trusted brands — refrigerators, TVs, air conditioners and more</p>
    </div>
</section>
<nav class="category-nav">
    <div class="container">
        <div class="category-nav-list">
            <a href="<?php echo esc_url(home_url('/appliances')); ?>" class="<?php echo empty($active_cat) ? 'active' : ''; ?>">All Appliances</a>
            <?php foreach ($appliance_keys as $key): ?>
                <a href="<?php echo esc_url(add_query_arg('category', $key, home_url('/appliances'))); ?>" class="<?php echo $active_cat === $key ? 'active' : ''; ?>"><?php echo esc_html($products[$key]['name']); ?></a>
            <?php endforeach; ?>
        </div>
    </div>
</nav>
<section class="section">
    <div class="container">
        ...
        <?php else: ?>
            <?php foreach ($appliance_keys as $key): $items = array_merge($items, $products[$key]['products']); endforeach; ?>
        <?php endif; ?>
